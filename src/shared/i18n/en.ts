...
export const en: Translations = {
  ...
  about: {
    ...
    bio: 'A well-organized folder structure and architecture, and detailed, consistent components, systems, and UI/UX bring me more joy than anything flashy. When the same problem shows up twice, I suspect the structure, not the code.\nAt CLO Virtual Fashion, I have worked across a range of services, from legacy migrations to a 3D fashion SaaS. I build features too, but I have spent more time on the work that keeps the team from solving the same problem twice — establishing code conventions and growing our design system from v1.0 to v4.0. Working on products made me curious about user experience, so I went to graduate school to research recommender systems. The research led me to the same conclusion: technology is a tool for the business, and I believe sustainable structure and a good user experience are what actually grow a service. Before asking how fast we can build something, I ask why we are building it. I believe decisions made that way serve both users and teammates longer.\nI love frontend work. I want to keep doing it for a long time, so I have exercised steadily for years — a healthy body and mind matter as much as good code. I also love reading — words on a screen get skimmed, but words on paper get chewed over, so I prefer paper.\nI want to be a developer who plays good catch. Good collaboration is, in the end, about throwing well and catching well — whether it is a code review or feedback, I try to throw so the other person can catch, and not to drop whatever comes my way.',
