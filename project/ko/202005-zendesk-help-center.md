...
| 인원 | 프론트엔드 (담당) |
| 서비스 링크 | [support.clo-set.com](https://support.clo-set.com) |
...
### Handlebars 템플릿 직접 수정으로 브랜드 통일된 헬프센터 구현
...
### CSS Grid · Handlebars 헬퍼로 콘텐츠 탐색 구조 설계
...
### URL 기반 locale 자동 전환으로 다국어 헬프센터 구축
